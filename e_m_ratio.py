...
df = pd.DataFrame({"Anode Voltage (V)":x, "Anode Voltage Error (V)":x_err, "Coil Current (A)":I, "Coil Current Error (A)":I_err, "Magnetic Field Strength (H)":y, "Magnetic Field Strength Error (A)":y_err})
